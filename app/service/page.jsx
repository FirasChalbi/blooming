...
function Page() {
  return (
    ...
    <section id="about">
      <div className="about-wrapper container6">
        <div className="about-text">
          <p className="small">Blooming</p>
    ...
    <p className="mt-4 text-sm leading-7 text-gray-500 font-regular text-center">
          SERVICES
        </p>
    <h3 className="text-3xl sm:text-5xl leading-normal font-extrabold tracking-tight text-gray-900 text-center mb-10 sm:mb-16">
          Nos<span style={{color:"#46C7C7"}}> Services</span>
        </h3>
        <a href="#0" className="banner mb-7" aria-label="Shop now">
            <div className="banner__grid">
              <div aria-hidden="true">
                <figure className="banner__figure" style={{backgroundImage: "url(/images/service1.jpg)"}}></figure>
              </div>
          ...
          <a href="#0" className="banner mb-7" aria-label="Shop now">
            <div className="banner__grid">
              <div aria-hidden="true">
                <figure className="banner__figure" style={{backgroundImage: "url(/images/service2.jpg)"}}></figure>
              </div>
          ...
          <a href="#0" className="banner mb-7" aria-label="Shop now">
            <div className="banner__grid">
              <div aria-hidden="true">
                <figure className="banner__figure" style={{backgroundImage: "url(/images/service3.jpg)"}}></figure>
              </div>
          ...
          <a href="#0" className="banner mb-7" aria-label="Shop now">
            <div className="banner__grid">
              <div aria-hidden="true">
              <figure className="banner__figure" style={{backgroundImage: "url(/images/service4.jpg)"}}></figure>
              </div>
          ...
          <a href="#0" className="banner mb-7" aria-label="Shop now">
            <div className="banner__grid">
              <div aria-hidden="true">
                <figure className="banner__figure" style={{backgroundImage: "url(/images/service5.jpg)"}}></figure>
              </div>
